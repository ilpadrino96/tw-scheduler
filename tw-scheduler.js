(() => {
  if(new URLSearchParams(window.location.search).get('try')!=='confirm') return UI.ErrorMessage("Acest script se poate folosi doar pe pagina de confirmare atac!");
  ...
  if(!document.getElementById("sTbl")){
    ...
    w.id="fw";w.style.display="flex";w.style.flexDirection="row";w.style.alignItems="flex-start";w.style.gap="20px";w.style.marginBottom="20px";
    f.insertBefore(w,d);w.appendChild(d);
    const t=document.createElement("table");
    t.id="sTbl";t.className="vis";t.width="460";
  ...
  if(!b){
    ...
    b.id="bSv";b.className="btn";b.type="button";b.textContent="⌛Salveaza";
    f.appendChild(b);
  }
  let to;
  b.onclick=()=>{
    ...
    sT("lt",fT(lt));sT("at",fT(at));sT("rt",fT(rt));
